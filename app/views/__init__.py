...
def init_admin_views(app, db):
    ...
    adminViews.add_view(ProductInventoryView(Product, db_session, name=lazy_gettext("Operation Suggestion"),
    ...
    adminViews.add_view(InventoryTransactionAdmin(InventoryTransaction, db_session, name=lazy_gettext("Adjust Inventory"),
                                                  category=lazy_gettext('Master Data'), menu_icon_type=ICON_TYPE_GLYPH,
                                                  menu_icon_value='glyphicon-transfer'))
    adminViews.add_view(ImportStoreDataView(name=lazy_gettext("Import Store Data"), category=lazy_gettext('Master Data'),
