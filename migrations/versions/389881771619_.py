...
def upgrade():
    ...
    # FIXME.xqliu Sequence of the table is not updated hence
    # new data can not be inserted into the table in UI after
    # migrate the patch, need to change the sequence start number manually.
    # Error Msg: Integrity error. (psycopg2.IntegrityError) duplicate key value violates unique constraint "enum_values_pkey" DETAIL: Key (id)=(1) already exists.
